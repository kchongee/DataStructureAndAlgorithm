...
public final class jdbcUtil
{
    ...
    public static HashMap<String, Object> readOne(String statement)
    {
        openConnection();
    ...
    public static ArrayList<String> getColumnLabel(ResultSet queryRslt)
    {
    ...
    public static ArrayList<HashMap<String, Object>> readAll(String statement)
    {
        openConnection();
        ...
        {
            queryRslt = SQL.executeQuery(statement);
            ArrayList<String> columnNames = getColumnLabel(queryRslt);
